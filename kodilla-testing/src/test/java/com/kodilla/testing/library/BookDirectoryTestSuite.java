...
class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf() {
        ...
        // Given
        LibraryUser libraryUser0 = new LibraryUser("Dominik", "Bernatowicz", "12234556788");
        LibraryUser libraryUser1 = new LibraryUser("Damian", "Basinski", "12345678988");
        LibraryUser libraryUser2 = new LibraryUser("Karol", "Kowalski", "98745632145");
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
